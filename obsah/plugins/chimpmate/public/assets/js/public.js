...
if(wpmcisset(wpmchimpa.litebox) || wpmcisset(wpmchimpa.addon) || wpmcisset(wpmchimpa.addon_scode) || wpmcisset(wpmchimpa.topbar) || wpmcisset(wpmchimpa.flipbox) || wpmcisset(wpmchimpa.widget) || wpmcisset(wpmchimpa.slider)){
	var wpmc_subing = 0;
