...
class ChimpMate_WPMC_Assistant {
	...
	public function load_plugin_textdomain() {
		...
		$this->wpmchimpa = get_option('wpmchimpa_options');
...
public function wpmchimpa_commentfield( $comment_field ) {
	if(isset($this->wpmchimpa['usyn_com']) && isset($this->wpmchimpa['usyn_comp']) && $this->wpmchimpa['usyn_comp']=='1')
    	return $comment_field.'<label><input type="checkbox" name="wpmchimpa" value="1">'.(isset($this->wpmchimpa['usyn_compt'])?$this->wpmchimpa['usyn_compt']: __('Subscribe to Newsletters', 'chimpmate-wpmca')).'</label>';
...
public function wpmchimpa_regfield(){
	if(isset($this->wpmchimpa['usyn_reg']) && isset($this->wpmchimpa['usyn_regp']) && $this->wpmchimpa['usyn_regp']=='1')
    	echo '<label><input type="checkbox" name="wpmchimpa" value="1">'.(isset($this->wpmchimpa['usyn_regpt'])?$this->wpmchimpa['usyn_regpt']: __('Subscribe to Newsletters', 'chimpmate-wpmca')).'</label>';
}
