...
.wpmchimpaf .wpmchimpa-subs-button::before{
  content: '<?php if(isset($theme['addon_button'])) echo $theme['addon_button'];else echo __( 'Subscribe', 'chimpmate-wpmca');?>';
  display: block;
}
...
content: '<?php if(isset($theme['addon_soc_head'])) echo $theme['addon_soc_head'];else echo __( 'Subscribe with', 'chimpmate-wpmca');?>';
font-size: 13px;
line-height: 13px;
color: #ADACB2;
width: 100%;
...
<div class="wpmchimpa-reset wpmchimpaf wpmchimpaf-close">
    <?php echo isset($theme['addon_heading'])?'<h3>'.$theme['addon_heading'].'</h3>' : '<h3>'.__( 'Subscribe Now', 'chimpmate-wpmca').'</h3>';?>
