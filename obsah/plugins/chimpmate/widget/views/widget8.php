...
content: '<?php if(isset($theme['widget_button'])) echo $theme['widget_button'];else echo __( 'Subscribe', 'chimpmate-wpmca');?>';
}
...
content: '<?php if(isset($theme['widget_soc_head'])) echo $theme['widget_soc_head'];else echo __( 'Subscribe with', 'chimpmate-wpmca');?>';
font-size: 13px;
color: #ADACB2;
width: 100%;
display: block;
