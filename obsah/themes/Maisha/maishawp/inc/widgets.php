...
<div class="clearfix">
<!-- celkový obalovací div na celou šířku-->

	<article id="post-<?php the_ID(); ?>" <?php post_class('uvod-article'); ?> >
	<!-- jeden article, uvnitř kterého má být obrázek a blok s texty-->
	

	<div class="column-right">
    	<div class="column-content">
      				
      		<header class="entry-header uvod-header">
					
				<h2 class="entry-title uvod-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>

<time class="entry-date published uvod-time" ><?php the_date(); ?></time>
			<? the_excerpt();
				?>
				</header><!-- .entry-header -->
...
<p class="archiv"><a href="/?post_type=post">Starší zprávy</a></p>
